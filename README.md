...
|    구분     | 기관                                                                                                             |        기간         | 비고                               |
| :---------: | :--------------------------------------------------------------------------------------------------------------- | :-----------------: | :--------------------------------- |
| 🏛️ **학력** | [동아대학교](https://computer.donga.ac.kr/) 컴퓨터공학과                                                         | `2019.03 ~ 2025.02` | 🎓 학사 졸업                       |
| 💼 **교육** | [SSAFY](https://www.ssafy.com/) 삼성 청년 SW AI 아카데미 13기                                                    |     `2025.01 ~`     | 👨‍🏫 1학기 CA (부반장)<br>📚 이수 중 |
| 🌐 **활동** | [GDSC Dong-A University](https://gdg.community.dev/gdg-on-campus-dong-a-university-busan-south-korea/) 1기 ~ 2기 | `2023.01 ~ 2024.09` | ⭐ Core Member                     |
...
|      프로젝트      | 한줄 요약                                     |           링크           |
| :----------------: | :-------------------------------------------- | :----------------------: |
| **🎮 Discord Bot** | 유튜브 스트리밍 및 AI 연동 다기능 디스코드 봇 | [바로가기](#discord-bot) |
...
| **02. 🤖 NAMUH (Tori)** | Vision AI 기반 소아암 환아 케어 휴머노이드 로봇        | [바로가기](#02--namuh-tori) |

</div>

  <details>
  <summary><b>01. 🦙 Alpacar</b></summary>
...
### 🛠️ My Tech Stack<img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white">
...
<details>
<summary><b>02. 🤖 NAMUH (Tori)</b></summary>
...
|          프로젝트           | 한줄 요약                           |                      링크                       |
| :-------------------------: | :---------------------------------- | :---------------------------------------------: |
| **📱 DataSet Maker for OD** | 객체 탐지용 데이터셋 생성/라벨링 툴 | [바로가기](#dataset-maker-for-object-detection) |
|     **🏃‍♂️ Run Together**     | 러닝 기록 공유 및 커뮤니티 앱       |            [바로가기](#run-together)            |
|     **🌉 Dream Bridge**     | 한부모 가구 ↔ 자선단체 연결 플랫폼  |            [바로가기](#dream-bridge)            |
| **🌱 University Plogging**  | 플로깅 기록 및 보상 시스템          |        [바로가기](#university-plogging)         |

</div>

<a id="dataset-maker-for-object-detection"></a>

<details>
<summary><b>📱 DataSet Maker for Object Detection</b></summary>

[![GitHub](https://img.shields.io/badge/GitHub-Repository-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/Me-in-U/DataSet_Maker_for_Object_Detection)
...
<details>
<summary><b>🏃‍♂️ Run Together (GDSC DAU 해커톤)</b></summary>

[![GitHub](https://img.shields.io/badge/GitHub-Repository-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/Me-in-U/Run_Together)
...
|          프로젝트           | 한줄 요약                                   |                링크                |
| :-------------------------: | :------------------------------------------ | :--------------------------------: |
|  **👰‍♀️ VTON Comfy UI API**   | StableDiffusion과 VTON 활용 가상 피팅       |   [바로가기](#vton-comfy-ui-api)   |
| **🖥 PC방 상품 주문 시스템** | PC방 내 상품 주문/결제 웹 시스템            | [바로가기](#pc방-상품-주문-시스템) |
|        **🏢 ZIPKOK**        | AI 챗봇 부동산 매물 추천 플랫폼             |        [바로가기](#zipkok)         |
|         **🐙 Tako**         | 블록체인 & AI 기반 TCG 카드 P2P 경매 플랫폼 |         [바로가기](#-tako)         |
...
|         프로젝트         | 한줄 요약                                  |              링크              |
| :----------------------: | :----------------------------------------- | :----------------------------: |
| **🔍 Clifa - AI Search** | Multilingual CLIP + FAISS 로컬 이미지 검색 | [바로가기](#clifa---ai-search) |
|     **🚨 신고하자**      | 게임 내 비매너 행위 신고 매크로            |     [바로가기](#신고하자)      |
