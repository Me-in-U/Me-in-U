...
| 💼 **교육** | 부산정보산업진흥원 스마트모빌리티 AI·빅데이터 교육                                                               | `2024.07.01 ~ 08.02` | ⏱️ 160시간          |
| 💼 **교육** | [SSAFY](https://www.ssafy.com/) 삼성 청년 SW AI 아카데미 13기                                                    | `2025.01 ~ 2025.12` | 👨‍🏫 1학기 CA (부반장) · ⏱️ 1,620시간 |
...
|             **🤖 NAMUH**             | Vision AI 기반 소아암 환아 케어 휴머노이드 로봇         |             [Github](https://github.com/Me-in-U/namuh)             |
| **🖥️ HomeAssistant E-Paper Display** | HomeAssistant Rest Api를 활용한 전자종이 디스플레이     | [Github](https://github.com/Me-in-U/HomeAssistant-E-Paper-Display) |
...
|          자격종목           | 시행기관                   |   합격일자   |
| :-------------------------: | :------------------------- | :----------: |
| **DIAT-프리젠테이션(고급)** | KAIT(한국정보통신진흥협회) | `2013.04.12` |
| **DIAT-스프레드시트(고급)** | KAIT(한국정보통신진흥협회) | `2013.02.15` |
|     **문서실무사 3급**      | 한국정보관리협회           | `2012.08.10` |
|     **아래한글 B등급**      | kpc(한글생산성본부)        | `2011.09.15` |
|  **한글파워포인트 A등급**   | kpc(한글생산성본부)        | `2011.03.31` |
